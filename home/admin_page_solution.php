...
<div class="container">
   ...
   <div class="admin-product-form-container">
      ...
      <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
         <h3>add a new solutions</h3>
         <input type="text" placeholder="enter your category" name="category_name" class="box">
         <input type="text" placeholder="enter your title" name="title_name" class="box">
         <input type="file" accept="image/png, image/jpeg, image/jpg" name="solution_image" class="box">
         <input type="text" placeholder="enter your url" name="url_name" class="box">
         <input type="submit" class="btn" name="add_solution" value="add solution"> 
      </form>
   ...
   <div class="product-display">
      <table class="product-display-table">
         ...
         <tr>
            <td><img src="uploaded_img/<?php echo $row2['img']; ?>" height="100" alt=""></td>
            <td><?php echo $row2['category']; ?></td>
            <td><?php echo $row2['title']; ?></td>
            <td><?php echo $row2['url']; ?></td>
            <td>
               <a href="admin_update_solution.php?edit2=<?php echo $row2['id']; ?>" class="btn"> <i class="fas fa-edit"></i> edit </a>
               <a href="admin_page_solution.php?delete2=<?php echo $row2['id']; ?>" class="btn"> <i class="fas fa-trash"></i> delete </a>
            </td>
         </tr>
      <?php } ?>
      </table>
