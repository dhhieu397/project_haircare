...
<body>
    <?php
        ...
        set_selected_type($TYPES->EQUIPMENT);
    ?>
    ...
    <section class="banner2" >
        ...
        <div class="row-banner2 banner-product">
            <div class="content2">
                <h3>SHOP <br> EQUIPMENTS</h3>
                <p> Discover our range of professional<br> hair tools crafted for quality styling results.</p>
                <a href="" onclick="return navigate(CURRENT_URL+'#equipments-content')" class="btn">Our equipments</a>
            </div>
        </div>
    ...
    <section id="equipments-content" class="page-content">
